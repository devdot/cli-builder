...
class ProductionContainer extends \Devdot\Cli\Container\CachedContainer
{
    ...
    {
        return $container->services['application'] = new \Devdot\Cli\Application('cli-builder', '1.0.0', new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader($container, $container->parameters['commands_as_map']), false);
    }
